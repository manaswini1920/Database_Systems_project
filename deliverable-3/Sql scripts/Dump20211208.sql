...
INSERT INTO `menu_items` VALUES (1,101,'Chicken Nuggets','Hot and Crispy Nuggets with some added spices',5.60),(2,101,'Vegetable Spring Roll','Roll consisting of mixed vegetables with crispy wonton wrapper',8.70),(3,106,'Chocolate Lava Cake','Lava Cake consisting of Hot Chocolate',6.80),(4,101,'French Fries','Hot and Crispy French Fries with Ranch',3.60),(5,102,'Chicken Soup','Hot Liquid Soup with Tinge of Chicken and Spices',7.05),(6,104,'Veggie Delight','A mix of boiled veggies with cheese and salad',8.40),(7,103,'Garden Salad','Fresh Romaine Lettuce with added carrots and grape tomatoes',10.20),(8,106,'Chocolate Brownie','Brownie with dry fruits topping',6.80),(9,105,'Orange Chicken','Chicken dipped in Orange Sauce',6.70),(10,106,'Steak Burger','Burger consisting of Steak and Sauce',12.60),(11,101,'Beef Spring Roll','Roll consisting of beef with crispy wonton wrapper',105.00),(12,103,'Romaine Salad','Fresh Romaine Lettuce with added cheese',8.20),(13,106,'Flavoured Yoghurt','Yoghurt in different flavours',4.80),(14,102,'Chicken Pizza','Hot and Soft Pizza with olives and chicken',10.05),(15,104,'Veg Sub','A mix of boiled veggies with salad dressing',7.60),(16,102,'Chicken Burger','Burger consisting of Chicken and Cheese',7.05),(17,104,'Chocolate Cookies','Choco Chip Cookies baked in low flame',4.40),(18,103,'SoftDrink','Drinks with Ice Cubes',3.20);
...
INSERT INTO `order_rating` VALUES (1,3,4,4,'Food is so good','https://www.pexels.com/photo/flat-lay-photography-of-vegetable-salad-on-plate-1640777/'),(2,5,4,3,'Food is delicious','https://www.pexels.com/photo/flat-lay-photography-of-vegetable-salad-on-plate-1640777/'),(3,7,2,4,'Food can be better','https://www.pexels.com/photo/flat-lay-photography-of-vegetable-salad-on-plate-1640777/'),(4,9,3,2,'Food is delivered too late','https://www.pexels.com/photo/flat-lay-photography-of-vegetable-salad-on-plate-1640777/'),(6,2,3,4,'Food is so good','https://www.pexels.com/photo/flat-lay-photography-of-vegetable-salad-on-plate-1640777/'),(7,2,4,2,'Food is delicious','https://www.pexels.com/photo/flat-lay-photography-of-vegetable-salad-on-plate-1640777/'),(8,2,1,4,'Food can be better','https://www.pexels.com/photo/flat-lay-photography-of-vegetable-salad-on-plate-1640777/'),(9,2,3,2,'Food is delivered too late','https://www.pexels.com/photo/flat-lay-photography-of-vegetable-salad-on-plate-1640777/'),(10,4,4,4,'Food is so good','https://www.pexels.com/photo/flat-lay-photography-of-vegetable-salad-on-plate-1640777/'),(11,4,5,2,'Food is delicious','https://www.pexels.com/photo/flat-lay-photography-of-vegetable-salad-on-plate-1640777/'),(12,4,2,4,'Food can be better','https://www.pexels.com/photo/flat-lay-photography-of-vegetable-salad-on-plate-1640777/'),(13,4,3,1,'Food is delivered too late','https://www.pexels.com/photo/flat-lay-photography-of-vegetable-salad-on-plate-1640777/'),(14,5,4,4,'Food is so good','https://www.pexels.com/photo/flat-lay-photography-of-vegetable-salad-on-plate-1640777/'),(15,4,4,5,'Food is delicious','https://www.pexels.com/photo/flat-lay-photography-of-vegetable-salad-on-plate-1640777/'),(16,3,1,3,'Food can be better','https://www.pexels.com/photo/flat-lay-photography-of-vegetable-salad-on-plate-1640777/'),(17,4,3,1,'Food is delivered too late','https://www.pexels.com/photo/flat-lay-photography-of-vegetable-salad-on-plate-1640777/');
...
INSERT INTO `order_status` VALUES (1,'Delivered'),(2,'Out for Delivery'),(3,'In the Kitchen'),(4,'Order Placed');
...
CREATE TABLE `payments` (
  ...
  CONSTRAINT `cust_id` FOREIGN KEY (`cust_id`) REFERENCES `person` (`person_id`)
...
INSERT INTO `payments` VALUES (1,2,1,21.63,7.75),(2,4,2,18.85,5.25),(3,5,3,17.89,4.75),(4,7,4,12.54,2.25),(5,6,5,4.88,1.86),(6,10,6,25.39,6.25),(7,15,7,14.68,9.23),(8,19,8,19.67,7.05);
...
--
/*!50003 DROP FUNCTION IF EXISTS `function_food_rating` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `function_food_rating`(
 rating INT
) RETURNS varchar(100) CHARSET utf8mb4
    DETERMINISTIC
BEGIN
    DECLARE food_rating varchar(100);
    IF rating = 1 THEN
		SET food_rating = "Food is bad";
	ELSEIF rating = 2 THEN
		SET food_rating = "Food can be better";
	ELSEIF rating = 3 THEN
		SET food_rating = "Food is ok";
	ELSEIF rating = 4 THEN
		SET food_rating = "Food is so good";
	ELSEIF rating = 5 THEN
		SET food_rating = "Food is delicious";
	END IF;
    RETURN food_rating; 
END ;;
DELIMITER ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP FUNCTION IF EXISTS `funct_driver_rating` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `funct_driver_rating`(
 rating INT
...
-- Dump completed on 2021-12-08 20:48:13
